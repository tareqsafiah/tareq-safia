...
<v-app>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-6 col-12" >
        ...
        <input type="email" class="form-control" placeholder="Enter Your Email..." id="email" name="email" required
          autofocus><br>
        <label for="Existing Websit">Existing Websit:</label><br>
      ...
      <div class="col-sm-12 col-md-6 col-12">
        ...
        <input type="tel" class="form-control" id="phone" name="tel" autofocus><br>
          <label for="Main Competitor Website">Main Competitor Website:</label><br>
        <input type="text" class="form-control" id="Main Competitor Website" name="Main Competitor Website" autofocus><br>
        </div>
      </div>
    </div>
        <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-4 col-12">
        ...
        <input type="checkbox" class="form-check-input myCheck" id="Category" value="SEO">
        <label for="SEO" class="form-check-label hov"> SEO</label><br>
      ...
      <div class="col-sm-12 col-md-4 col-12" data-v-d53af812="" style="top:5%">
        ...
        <label for="Other" class="form-check-label hov"> Other</label><br><br>
        </div>
            </div>
      </div>
    </div>
...
input[type=text] ,[type=date] , [type=url] ,[type=email] ,[type=tel] {
    left: 10%;
  width: 75%;
  padding: 8px 16px;
  margin: 4px 0;
